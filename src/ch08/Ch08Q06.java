...
/*    */       }
/*    */     } 
/* 22 */     double[][] result = multiplyMatrix(matrix1, matrix2);
...
/* 26 */         System.out.printf("%5.1f", new Object[] { Double.valueOf(matrix1[j][k]) });
/*    */       } 
/* 28 */       if (j != 1) {
/* 29 */         System.out.print("\t\t");
/*    */       } else {
...
/* 35 */         System.out.printf("%5.1f", new Object[] { Double.valueOf(matrix2[j][k]) });
/*    */       } 
/* 37 */       if (j != 1) {
/* 38 */         System.out.print("\t\t");
/*    */       } else {
...
/* 44 */         System.out.printf("%5.1f", new Object[] { Double.valueOf(result[j][k]) });
/*    */       } 
...
/* 54 */         for (int k = 0; k < (result[i]).length; k++) {
/* 55 */           result[i][j] = result[i][j] + a[i][k] * b[k][j];
/*    */         }
/*    */       } 
/*    */     } 
/* 59 */     return result;
...
/* Location:              /Volumes/TXS.128G/hope useful/practice/2020.jar!/ch08/Ch08Q06.class
